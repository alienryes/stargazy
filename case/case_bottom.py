...
# Their strap spans case X 49.0..64.5 - inboard edge clear of the -X wall at
# -48.5, outboard edge flush with half_x.
stand_strap_x0 = 49.0
...
print(f"case_bottom v{VERSION}: plate {2*half_x:.1f} x {2*half_y:.1f}, "
      ...
      f"bare flanges for the stands from x +-{stand_strap_x0} to +-{half_x}")
